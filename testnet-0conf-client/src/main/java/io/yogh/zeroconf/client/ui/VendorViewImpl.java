package io.yogh.zeroconf.client.ui;
...
public class VendorViewImpl extends Composite implements VendorView {
  interface VendorViewUiBinder extends UiBinder<Widget, VendorViewImpl> {
  }

  private static final VendorViewUiBinder UI_BINDER = GWT.create(VendorViewUiBinder.class);
  ...
  @Inject
  public VendorViewImpl(final ApplicationServiceAsync service) {
